...
class CyberPortfolio {
    ...
    initializeSkillsGraph() {
        if (typeof window.SkillsGraph !== 'undefined') {
            const skillsGraph = new SkillsGraph();
            skillsGraph.render('#skills-graph', portfolioData.skills);
        }
    }

    initializeCertificationsSlider() {
        if (typeof window.CertificationsSlider !== 'undefined') {
            const slider = new CertificationsSlider();
            slider.init(portfolioData.certifications);
        }
    }
